...
$options['general-title_text_transform'] = array(
	'name'       => _x( 'Text transformation', 'theme-options', 'the7mk2' ),
	'id'         => 'general-title_text_transform',
	'type'       => 'select',
	'std'        => 'none',
	'options'    => array(
		'none'       => 'None',
...
$options['general-breadcrumbs_text_transform'] = array(
	'name'       => _x( 'Text transformation', 'theme-options', 'the7mk2' ),
	'id'         => 'general-breadcrumbs_text_transform',
	'type'       => 'select',
	'std'        => 'none',
	'options'    => array(
		'none'       => 'None',
