...
class The7_Inc_Shortcodes_VCParams {
	...
	public function enqueue_icon_picker_styles() {
		...
		the7_register_style( 'dt-awsome-fonts-back', PRESSCORE_THEME_URI . '/fonts/FontAwesome/back-compat' );
		the7_register_fontawesome_style( 'font-awesome' );
		wp_enqueue_style( 'font-awesome' );
		wp_enqueue_style( 'dt-awsome-fonts-back' );
	}
	...
	public function dt_icon_settings_field( $settings, $value ) {
		...
		return The7_Option_Field_Icons_Picker::html( $settings['param_name'], $settings['param_name'], $value, array(
			'icons' => $icons,
			'value_input_class' => 'wpb_vc_param_value',
		) );
	}
