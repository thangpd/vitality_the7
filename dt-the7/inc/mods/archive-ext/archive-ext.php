...
if ( ! class_exists( 'Presscore_Modules_ArchiveExtModule', false ) ) :
	...
	class Presscore_Modules_ArchiveExtModule {
		...
		public static function show_ultimate_styles() {
			...
			add_filter( 'ultimate_global_scripts', array( __CLASS__, 'display_ultimate_global_styles' ) );
		}

		/**
		 * Return 'enable' string. Used for `ultimate_global_scripts` filter.
		 *
		 * @since 7.3.0
		 *
		 * @return string
		 */
		public static function display_ultimate_global_styles() {
			return 'enable';
		}
