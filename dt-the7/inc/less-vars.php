...
function presscore_action_add_less_vars( $less_vars ) {
	...
	$less_vars->add_keyword( 'top-bar-text-transform', of_get_option( 'top_bar-font-text_transform' ) );
	...
	$less_vars->add_keyword( 'menu-text-transform', of_get_option( 'header-menu-font-text_transform' ) );
	...
	$less_vars->add_keyword( 'submenu-text-transform', of_get_option( 'header-menu-submenu-font-text_transform' ) );
	...
	), of_get_option( 'header-top_line-elements-in_top_line-font_family' ) );

	$less_vars->add_pixel_number( 'microwidgets-in-top-line-font-size', of_get_option( 'header-top_line-elements-in_top_line-font_size' ) );
	...
	$less_vars->add_keyword( 'filter-text-transform', of_get_option( 'general-filter_text_transform' ) );
	...
	if ( function_exists( 'presscore_themeoptions_get_headers_defaults' ) ) {
		...
		foreach ( presscore_themeoptions_get_headers_defaults() as $id => $opts ) {
			...
			$less_vars->add_keyword( "{$id}-text-transform", of_get_option( "fonts-{$id}_text_transform" ) );
	...
	), of_get_option( 'menu-mobile-microwidgets-font-family' ) );

	$less_vars->add_pixel_number( 'mobile-menu-microwidgets-font-size', of_get_option( 'menu-mobile-microwidgets-font-size' ) );
	...
	$less_vars->add_keyword( 'mobile-menu-text-transform', of_get_option( 'header-mobile-menu-font-text_transform' ) );
	...
	$less_vars->add_keyword( 'mobile-sub-menu-text-transform', of_get_option( 'header-mobile-submenu-font-text_transform' ) );
	...
	$less_vars->add_keyword( 'breadcrumbs-text-transform', of_get_option( 'general-breadcrumbs_text_transform' ) );
	...
	$less_vars->add_keyword( 'page-title-text-transform', of_get_option( 'general-title_text_transform' ) );
	...
	if ( function_exists( 'presscore_themeoptions_get_buttons_defaults' ) ) {
		...
		foreach ( presscore_themeoptions_get_buttons_defaults() as $id => $opts ) {
			...
			$less_vars->add_keyword( "dt-btn-{$id}-text-transform", of_get_option( "buttons-{$id}_text_transform", $opts['tt'] ) );
