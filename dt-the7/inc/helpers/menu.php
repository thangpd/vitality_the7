...
if ( ! function_exists( 'presscore_nav_menu_list' ) ) :
	 ...
	 * @param  array  $class
	 * @param string  $before_menu_name
	 * @param string  $after_menu_name
	 */
	function presscore_nav_menu_list( $location, $class = array(), $before_menu_name = '', $after_menu_name = '' ) {
		...
		echo '<div class="menu-select"><span class="customSelect1"><span class="customSelectInner">' . $before_menu_name . esc_html( $menu->name ) . $after_menu_name . '</span></span></div>';
		echo '</div>';
	}
